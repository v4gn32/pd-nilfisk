...
const DocumentCard: React.FC<DocumentCardProps> = ({ document, onDownload, onDelete }) => {
  ...
  return (
    <Card className={`hover:shadow-lg transition-all duration-300 border ${getDocumentColor(document.type)}`}>
      <CardContent className="p-6">
        <div className="flex items-start gap-4">
          <div className={`p-3 rounded-xl ${getDocumentColor(document.type)} shadow-sm`}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-2 flex flex-col gap-1">
              ...
              <div className="flex items-center text-xs text-gray-500">
                ...
                <span className="truncate">
                  Adicionado em {new Date(document.createdAt).toLocaleDateString('pt-BR', {
                    day: '2-digit',
                    month: '2-digit',
                    year: 'numeric'
                  })}
