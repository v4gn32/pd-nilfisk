...
const Settings: React.FC = () => {
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.error || 'Erro ao alterar a senha'
      );
    } finally {
      setLoading(false);
    }
          ...
          <CardContent>
            <form onSubmit={handleSaveProfile} className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <Input label="Nome Completo" value={user?.name} disabled fullWidth />
                <Input label="CPF" value={user?.cpf || ''} disabled fullWidth />
              </div>
              <Input label="E-mail" value={user?.email} disabled fullWidth />
            </form>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <select
              ...
              onChange={(e) =>
                updateSettings({ language: e.target.value as 'pt-BR' | 'en' })
              }
