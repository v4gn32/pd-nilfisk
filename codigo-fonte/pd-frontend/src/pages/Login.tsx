      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white/10 backdrop-blur-sm border-gray-700">
          ...
          <CardFooter className="flex justify-center border-t border-gray-700">
            <p className="text-sm text-gray-400">
              Não tem uma conta? <Link to="/register" className="text-[#38AFD9] hover:underline">Cadastre-se</Link>
            </p>
          </CardFooter>
        </Card>
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-gray-400">
            ...
            Email: admin@nilfisk.com<br />
            Senha: admin123
          </p>
          <p className="text-sm text-gray-400 mt-2">
            <strong>Credenciais de Usuário:</strong><br />
